...
using HospitalManagement.DataAccessLayer.DataContext;
...
namespace HospitalManagement.DataAccessLayer.DbAccess
{
    public class UnitOfWork : IDisposable
    {
        ...
        private IRepository<PatientInfo>? _PatientInfoRepository;
        ...
        public IRepository<PatientInfo> PatientInfoRepository =>
            _PatientInfoRepository ??= new GenericRepository<PatientInfo>(_dbContext);
